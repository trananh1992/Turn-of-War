...
import com.group7.dragonwars.R.anim;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent myIntent = new Intent(MainGyroSplash.this, MenuActivity.class);
				startActivity(myIntent);
				overridePendingTransition(anim.push_from_below_in, anim.push_from_below_out);
