...
private String mobility;
	...
	public Unit(final String name, final Double maxHealth, String mobility, final Integer maxMovement, final Double attack, final Double meleeDefense, final Double rangeDefense, final Boolean isRanged, final Boolean isFlying, final Boolean isBoat, final Integer productionCost, final String spriteLocation, final String spriteDir, final String spritePack) {
	...
	public Unit(final Unit unit) {
		...
		super(unit.getName(), unit.getSpriteLocation(), unit.getSpriteDir(), unit.getSpritePack());
	...
	public void setFinishedTurn(final Boolean b) {
		...
		// String A2 = "yolo2";
		// Log.v(A2, this.getSpriteLocation() + " " + this.getSpriteDir() + " " + this.getSpritePack() + " " + this.getInfo());
	}
