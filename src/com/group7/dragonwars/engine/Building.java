...
public final class Building extends DrawableMapObject {
	...
	public Building(final String name, final Integer captureDifficulty, final Double attackBonus, final Double defenseBonus, final Boolean goalBuilding, final Integer captureWorth, final String spriteLocation, final String spriteDir, final String spritePack) {
	...
	public Building(final Building building) {
		super(building.getName(), building.getSpriteLocation(), building.getSpriteDir(), building.getSpritePack());
	...
	public  Player reduceCaptureTime(final Integer captureAmount) {
		...
		if (this.remainingCaptureTime <= 0) {
			...
			this.capturedGoalBuilding(); // line to disable HQ property of any captured properties (1 HQ mode)
